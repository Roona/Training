...
public class RoleHome {
	...
	public Role findById(int id) {
		...
		try {
			Role instance = (Role) sessionFactory.getCurrentSession().get("com.roona.Role", id);
			if (instance == null) {
	...
	public List<Role> findByExample(Role instance) {
		...
		try {
			List<Role> results = (List<Role>) sessionFactory.getCurrentSession().createCriteria("com.roona.Role")
