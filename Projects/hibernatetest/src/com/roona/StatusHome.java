...
public class StatusHome {
	...
	public Status findById(int id) {
		...
		try {
			Status instance = (Status) sessionFactory.getCurrentSession().get("com.roona.Status", id);
			if (instance == null) {
	...
	public List<Status> findByExample(Status instance) {
		...
		try {
			List<Status> results = (List<Status>) sessionFactory.getCurrentSession().createCriteria("com.roona.Status")
