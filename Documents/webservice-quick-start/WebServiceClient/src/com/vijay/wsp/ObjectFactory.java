 ...
 * generated in the com.vijay.wsp package. 
...
public class ObjectFactory {
    ...
    private final static QName _HelloWorld_QNAME = new QName("http://wsp.vijay.com/", "helloWorld");
    private final static QName _HelloWorldResponse_QNAME = new QName("http://wsp.vijay.com/", "helloWorldResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.vijay.wsp
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://wsp.vijay.com/", name = "helloWorld")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://wsp.vijay.com/", name = "helloWorldResponse")
