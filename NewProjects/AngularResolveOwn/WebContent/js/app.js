...
app.config(function ($locationProvider, $routeProvider) {
    ...
    $routeProvider.when("/:cityName", {
        ...
        controller :function ($scope, $routeParams, crew) {
        	/*if( $routeParams.cityName == 'Enterprise-D'){
        		 $scope.img = "newyork.jpg";
        	}else if( $routeParams.cityName == 'Voyager'){
        		 $scope.img = "dubai.jpg";
        	}else if( $routeParams.cityName == 'Tokyo'){
        		 $scope.img = "tokyo.jpg";
        	}*/
        ...
        resolve    :{
            crew:function ($q, $route, $timeout, cityDetailResource) {
                ...
                $timeout(function () {
                    cityDetailResource.getCrewByStarship(cityName, successCb);
                }, 2000);
